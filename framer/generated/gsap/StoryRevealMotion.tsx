...
export default function StoryRevealMotion(props: Props) {
...
StoryRevealMotion.defaultProps = {
  title: "story-reveal",
...
addPropertyControls(StoryRevealMotion, {
  title: { type: ControlType.String, title: "Title", defaultValue: "story-reveal" },
